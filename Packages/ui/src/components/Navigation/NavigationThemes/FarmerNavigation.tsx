...
export const FarmerNavigationComponent = ({teams,navData,user, bgColor, searchData, searchPrompt }: FarmerNavigationDto) => {
    ...
    return <>
                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  >
                    <div className="absolute left-full top-0 flex w-16 justify-center pt-5">
                      <button type="button" className="-m-2.5 p-2.5" onClick={() => setSideOpen(false)}>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className={classMerge(`${bgColor}`,"flex grow flex-col gap-y-5 overflow-y-auto px-6  pb-4")}>
            <div className="flex h-16 shrink-0 items-center">
        ...
        <div className="lg:pl-72">
          <div className="sticky top-0 z-40 flex h-12 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            <button type="button" className="-m-2.5 p-2.5 text-gray-700 lg:hidden" onClick={()=>setSideOpen(true)}>
           ...
           {<SearchComponent searchPrompt={searchPrompt} searchData={searchData}/>}
              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                ...
                <div className="hidden lg:block lg:h-6 lg:w-px lg:bg-gray-900/10" aria-hidden="true" />
                    <NavigationProfileComponent navData={navData} user={user} />
              </div>
            </div>
          </div>
