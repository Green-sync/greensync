...
export default function ModernaFarmTheme() {
          ...
          <main className="lg:pr-96">
            ...
            <ul role="list" className="divide-y divide-white/5">
              {deployments.map((deployment:any,index:number) => (
                <li key={index} className="relative flex items-center space-x-4 px-4 py-4 sm:px-6 lg:px-8">
                  <div className="min-w-0 flex-auto">
                    <div className="flex items-center gap-x-3">
                      <div className={classMerge(statuses[deployment.status as string], 'flex-none rounded-full p-1')}>
