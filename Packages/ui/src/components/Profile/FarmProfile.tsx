...
export const FarmProfile = (farmData: IFarms) => {
    ...
    return(
        ...
        <div className="p-4 grid grid-cols-1 md:grid-cols-2">
            <div className="lg:w-1/2  lg:border-r-4 md:mr-6">
            ...
            {/* ========================================================================================================================= */}
             {
              ...
              {/* <!-- Sidebar --> */}
              <div className=" text-green-900 py-4 px-6">
                  {/* <!-- Sidebar content goes here --> */}
                  <ul className="flex space-x-2">
                  <a className="px-2 py-1 rounded-md hover:bg-gray-700">
                      <a href="#" className="block">{farmData.farmType === "Crops" ? "Crops" : "Livestock"}</a>
                  </a>
                  <a className="px-2 py-1 rounded-md hover:bg-gray-700">
                      <a href="#" className="block">Land Management</a>
                  </a>
                  <a className="px-2 py-1 rounded-md hover:bg-gray-700">
