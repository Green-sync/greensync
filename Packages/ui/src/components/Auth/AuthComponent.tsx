...
export const AuthComponent = ({ theme, image, authenticate, handleInputChange, userData ,authType }: AuthComponentProps) => {
...
{/* =======================================================LOGIN==================================================================== */}
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 pl-2"
                  >
                    Sign in
                  </button>
          ...
          <div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <a
                ...
                className="flex w-full items-center justify-center gap-3 rounded-md bg-green-500 px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0]"
              >
