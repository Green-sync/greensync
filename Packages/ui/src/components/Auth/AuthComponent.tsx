...
export const AuthComponent = ({ theme, image,option,colors }: AuthComponentProps) => {
    ...
    return <>
    {
        ...
        <>
        <section>
         <div className="text-red-500 flex items-center min-h-screen p-6 bg-green-100 dark:bg-gray-900">
        <div
            ...
            <div className="flex flex-col overflow-y-auto md:flex-row">
                ...
                <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div className="w-full">
                        ...
                        <a
                            className={colors? colors:"block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150  border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"}
                            href="../index.html"
                        >
                            Log in
                        </a>
