...
export const AuthComponent = ({ image, authenticate, handleInputChange ,authType }: AuthComponentProps) => {
      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
            <h2 className="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-900">
              Sign {authType === "login" ? " In" : " Up"} to your account
            </h2>

          <div className="mt-10">
            <div>
{/* =======================================================LOGIN==================================================================== */}
              <form id="custom,login" className={authType == "login" ?  "space-y-6" : 'hidden' }
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm leading-6 pointer" onClick={() => authType = "register"}>
                  <a className="font-semibold leading-4 text-indigo-600 hover:text-indigo-500 " >New here? Create Account</a>
                  </div>
              </form>
            </div>
{/* =============================================================REGISTER================================================================================= */}
          <form id="custom,registration" className={authType == "register" ? "space-y-6" : 'hidden' } 
           onSubmit={authenticate}
          >
            <div>
      ...
      <p className="text-red-500 text-xs italic">Passwords do not match.</p>
            ...
            <div>
              ...
              <div className="text-sm leading-6" onClick={() => authType = "login"}>
