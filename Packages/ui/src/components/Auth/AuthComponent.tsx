          ...
          <div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <a
                ...
                className="flex w-full items-center justify-center gap-3 rounded-md bg-lime-900 px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0]"
              >
