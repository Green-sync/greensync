...
import { CreateUserAccount, SocialLogin, LoginnWithEmailAndPassword,UserDetails } from "../../firebase";
...
export default function LoginForms() {
  ...
  const handleInputChange = (e: any) => {
    const nme = e.target.id;
   // @ts-ignore
    userData[`${nme}`] = e.target.value;
    ...
    const authenticate = async (e: any) => {
      ...
      if(option ==="custom" && provider ==='login'){
        ...
        if(passwordMatch) {
        const isloggedIn= await CreateUserAccount(userData)
        return isloggedIn ? nav("/"): null
        }
      }
          ...
          <div className="flex  flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div className="mx-auto w-full max-w-sm lg:w-96">
              ...
              <div className="mt-10 ">
                <div className="">
{/* =======================================================LOGIN==================================================================== */}
                  <form id="custom,login" className={signInType == "Login" ?  "space-y-6  p-4 border-slate-900" : 'hidden'}
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        type="submit"
                        className="flex w-full justify-center rounded-md bg-lime-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-lime-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 pl-2"
                      >
                        Sign in
                      </button>
...
{/* =============================================================REGISTER================================================================================= */}
              <form id="custom,registration" className={signInType == "Register" ? "space-y-6" : 'hidden' } 
               onSubmit={authenticate}
              >
                <div>
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      required
                      className={`block w-full rounded-md border-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 ${ !passwordMatch ? "border-red-500" : "" } sm:text-sm sm:leading-6 pl-2`}
                    />
                  </div>
                  {!passwordMatch && (
 ...
 {/* ===========================================SOCIALS=============================================================================================================================================  */}
              <div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  ...
                  <a
                    href="/" id="social,facebook"
                    onClick={authenticate}
                    className="flex w-full items-center justify-center gap-3 rounded-md bg-yellow-600 px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F]"
                  >
