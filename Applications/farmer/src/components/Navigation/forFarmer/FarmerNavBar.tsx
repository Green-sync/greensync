...
export const navigation: NavigationItem[] = [
    ...
    },
    {
        ...
        current: false,
        subItems: [
            { name: "My Crops", icon: null, href: "/crops/my-crops", current: false },
            { name: "Sell Crops", href: "/crops/sell-crops", current: false, icon: null },
        ],
    },
    {
        name: "LiveStock",
        ...
        current: false,
        subItems: [
            { name: "My LiveStock", href: "/livestock/my-livestock", current: false, icon: null },
            { name: "Sell LiveStock", href: "/livestock/sell-livestock", current: false, icon: null },
        ],
    },
];

export const teams = [
    { id: 1, name: 'Devices', href: '#', initial: 'D', current: false },
    { id: 2, name: 'Tools', href: '#', initial: 'T', current: false },
    { id: 3, name: 'Equipment', href: '#', initial: 'E', current: false },
    { id: 4, name: 'Machinery', href: '#', initial: 'M', current: false },
];
...
export default function FarmerSideBarComponent() {
                      ...
                      /> */}
                                        ...
                                        <nav className="flex flex-1 flex-col">
                                            <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                                ...
                                                <li>
                                                    <div className="text-xs font-semibold leading-6 text-gray-400">Market Place</div>
                            ...
                            <div className="flex items-center gap-x-4 lg:gap-x-6">
                                ...
                                <Menu as="div" className="relative">
                                    <Menu.Button className="-m-1.5 flex items-center p-1.5">
                                        ...
                                        {/*Dineo will Provide Real Profile here*/}
